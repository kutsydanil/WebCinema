...
namespace WebCinema.Controllers
{
    public class FilmsController : Controller
    {
        ...
        {
            ViewData["CountryProductionId"] = new SelectList(_context.CountryProductions, "Id", "Id");
            ViewData["FilmProductionId"] = new SelectList(_context.FilmProductions, "Id", "Country");
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,GenreId,Duration,FilmProductionId,CountryProductionId,AgeLimit,Description")] Films films)
        {
            ...
            ViewData["CountryProductionId"] = new SelectList(_context.CountryProductions, "Id", "Id", films.CountryProductionId);
            ViewData["FilmProductionId"] = new SelectList(_context.FilmProductions, "Id", "Country", films.FilmProductionId);
